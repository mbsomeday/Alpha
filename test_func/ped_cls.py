...
def test_ped_classifier(model_obj, weights_path, ds_name_list, batch_size, txt_name, path_key):
    '''
        测试行人分类模型
    '''
    ...
    ped_dataset = my_dataset(ds_name_list=ds_name_list, path_key=path_key, txt_name=txt_name)
